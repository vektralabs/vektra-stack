...
| 8 | [admin-ui](20260301-admin-ui.md) | HTMX + Jinja2 admin dashboard | 12 | completed |
...
| # | Plan | Title | Tasks | Status |
|---|------|-------|-------|--------|
| 10 | [component-learn](20260301-component-learn.md) | LMS-agnostic API, chatbot widget | 18 | in_progress |
