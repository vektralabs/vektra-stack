"""Shared fixtures for vektra-shared unit tests."""
...
def _hermetic_env(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    overriding the defaults asserted by test_config.py. CI has no .env and
    never sees the difference. Tests that need a specific value still set it
