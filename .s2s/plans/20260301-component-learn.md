...
The built `static/vektra-chat.js` is committed to the repository so that the Python package works without Node.js at runtime. The Docker build also runs the widget build step to ensure freshness.
